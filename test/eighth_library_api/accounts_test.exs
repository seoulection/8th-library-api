defmodule EighthLibraryApi.AccountsTest do
  use EighthLibraryApi.DataCase

  alias EighthLibraryApi.Accounts

  describe "users" do
    alias EighthLibraryApi.Accounts.User

    @valid_attrs %{email: "some email", first_name: "some first_name", image_url: "some image_url", last_name: "some last_name"}
    @update_attrs %{email: "some updated email", first_name: "some updated first_name", image_url: "some updated image_url", last_name: "some updated last_name"}
